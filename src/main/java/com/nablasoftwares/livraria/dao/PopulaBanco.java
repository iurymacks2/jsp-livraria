package com.nablasoftwares.livraria.dao;
...
public class PopulaBanco {
	...
	public static void main(String[] args) {
		...
		Autor tolkien = geraAutor("J.R.R. Tolkien");
		em.persist(tolkien);
		...
		Livro duasTorres = geraLivro("978-8-52-504464-8", "Lord of The Rings: Two Towers",
				"10/01/2001", 62.90, tolkien);
